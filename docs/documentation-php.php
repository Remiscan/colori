...
$couleur->hwb() == 'hwb(351 11% 42% / 0.3)'</code></pre>
</div>
...
$rouge->hwb() == 'hwb(0 0% 0%)'
$rouge->hwba() == 'hwb(0 0% 0% / 1)'</code></pre>
...
$fusion = Couleur::blend($transparente, $opaque);</code></pre>
  ...
  <pre class="output"><code slot="output" class="language-php">$fusione->rgb() == 'rgb(128, 128, 128)'</code></pre>
</div>
...
<div class="example-code">
  <pre class="input"><code class="language-php">$nouvelleCouleur = $rouge->darken('10%', {scale: true});</code></pre>
...
<p class="h3"><code class="language-php">greyscale</code></p>
