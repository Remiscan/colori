...
class Couleur
{
  ...
  private static function parse(string|float|int $value, ?string $prop = null, bool $clamp = true): float {
    ...
    elseif (in_array($prop, ['h', 'cieh'])) {
      $h = floatval($value);
      // If n is a number
      if (preg_match('/^' . self::vNum . '$/', $value)) {
        return (float) Utils::angleToRange($h);
      }
      // If n is an angle
      elseif (preg_match('/^' . self::vAng . '$/', $value)) {
  ...
  private function setColor(string $spaceID, array $rgba): void {
    ...
    switch ($spaceID) {
      ...
      case 'xyz':
        ...
        break;
      default:
        throw new Exception("The ". json_encode($spaceID) ." color space is not supported");
    }
 ...
 */
class Utils {
  public static function pad(string $s): string {
  ...
  public static function pRound(float $number, int $precision = 5): float {
    $x = (float) $number;
  ...
  public static function srgb_to_lin_srgb(array $rgb): array {
  ...
  public static function lin_srgb_to_srgb(array $rgb): array {
    return array_map(function($x) {
      $sign = $x < 0 ? -1 : 1;
  ...
  public static function lin_srgb_to_d65xyz(array $rgb): array {
    [$r, $g, $b] = $rgb;
    return [
  ...
  public static function d65xyz_to_lin_srgb(array $xyz): array {
    [$x, $y, $z] = $xyz;
    return [
  ...
  public static function srgb_to_hsl(array $rgb): array {
  ...
  public static function hsl_to_srgb(array $hsl): array {
  ...
  public static function hsl_to_hwb(array $hsl): array {
  ...
  public static function hwb_to_hsl(array $hwb): array {
    // Source of the math: https://en.wikipedia.org/wiki/HSL_and_HSV#HSV_to_HSL
    //                   & http://alvyray.com/Papers/CG/HWB_JGTv208.pdf
    [$h, $w, $bk] = $hwb;
  ...
  public static function displayp3_to_lin_displayp3(array $rgb): array { return self::srgb_to_lin_srgb($rgb); }
  public static function lin_displayp3_to_displayp3(array $rgb): array { return self::lin_srgb_to_srgb($rgb); }

  public static function lin_displayp3_to_d65xyz(array $rgb): array {
    [$r, $g, $b] = $rgb;
    return [
  ...
  public static function d65xyz_to_lin_displayp3(array $xyz): array {
    [$x, $y, $z] = $xyz;
    return [
  ...
  public static function prophotorgb_to_lin_prophotorgb(array $rgb): array {
    foreach($rgb as $k => $v) {
      $sign = $v < 0 ? -1 : 1;
  ...
  public static function lin_prophotorgb_to_prophotorgb(array $rgb): array {
    foreach($rgb as $k => $v) {
      $sign = $v < 0 ? -1 : 1;
  ...
  public static function lin_prophotorgb_to_xyz(array $rgb): array {
    [$r, $g, $b] = $rgb;
    return [
  ...
  public static function xyz_to_lin_prophotorgb(array $xyz): array {
    [$x, $y, $z] = $xyz;
    return [
  ...
  public static function a98rgb_to_lin_a98rgb(array $rgb): array {
    foreach($rgb as $k => $v) {
      $sign = $v < 0 ? -1 : 1;
  ...
  public static function lin_a98rgb_to_a98rgb(array $rgb): array {
    foreach($rgb as $k => $v) {
      $sign = $v < 0 ? -1 : 1;
  ...
  public static function lin_a98rgb_to_d65xyz(array $rgb): array {
    [$r, $g, $b] = $rgb;
    return [
  ...
  public static function d65xyz_to_lin_a98rgb(array $xyz): array {
    [$x, $y, $z] = $xyz;
    return [
  ...
  public static function rec2020_to_lin_rec2020(array $rgb): array {
    $e = 1.09929682680944;
    foreach($rgb as $k => $v) {
      $sign = $v < 0 ? -1 : 1;
  ...
  public static function lin_rec2020_to_rec2020(array $rgb): array {
    $e = 1.09929682680944;
    foreach($rgb as $k => $v) {
      $sign = $v < 0 ? -1 : 1;
  ...
  public static function lin_rec2020_to_d65xyz(array $rgb): array {
    [$r, $g, $b] = $rgb;
    return [
  ...
  public static function d65xyz_to_lin_rec2020(array $xyz): array {
    [$x, $y, $z] = $xyz;
    return [
  ...
  public static function xyz_to_lab(array $xyz): array {
    $ε = 216/24389;
    $κ = 24389/27;
    $w = [0.96422, 1, 0.82521];
  ...
  public static function lab_to_xyz(array $lab): array {
    $ε = 216/24389;
    $κ = 24389/27;
    $w = [0.96422, 1, 0.82521];
  ...
  public static function lab_to_lch(array $lab): array {
    [$ciel, $ciea, $cieb] = $lab;
  ...
  public static function lch_to_lab(array $lch): array {
    [$ciel, $ciec, $cieh] = $lch;
  ...
  public static function d65xyz_to_xyz(array $xyz): array {
    [$x, $y, $z] = $xyz;
    return [
  ...
  public static function xyz_to_d65xyz(array $xyz): array {
    [$x, $y, $z] = $xyz;
    return [
  ...
  public static function luminance(array $rgb): float {
    $rgb = self::srgb_to_lin_srgb($rgb);
    return 0.2126 * $rgb[0] + 0.7152 * $rgb[1] + 0.0722 * $rgb[2];
  }

  public static function WCAG2contrast(array $rgbText, array $rgbBack): float {
    $L1 = self::luminance($rgbText);
    $L2 = self::luminance($rgbBack);
    return (max($L1, $L2) + 0.05) / (min($L1, $L2) + 0.05);
  }

  public static function APCAcontrast(array $rgbText, array $rgbBack): float {
  ...
  public static function CIEDE2000(array $lab1, array $lab2): float {
