...
const oklabGamut = {
  ...
  cusp: function(a, b) {
    ...
    const rgbMax = Conversion.oklab_to_lin_srgb([1, Scusp * a, Scusp * b]);
  ...
  clip: function(rgb) {
    ...
    const [okl, oka, okb] = Conversion.lin_srgb_to_oklab(Conversion.srgb_to_lin_srgb(rgb));
    const [x, okc, okh] = Conversion.oklab_to_oklch([okl, oka, okb]);
    ...
    const clampedValues = Conversion.lin_srgb_to_srgb(Conversion.oklab_to_lin_srgb([Lclipped, Cclipped * a, Cclipped * b]));
